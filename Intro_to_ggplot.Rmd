...
We will use three data sets that either come with the ggplot2 package.    
...
```{r geom_col with stats, fig.align = 'center', fig.height = 3, fig.width=3}
ggplot(drugs) +
...
```{r override stats, fig.align='center', fig.height=4}
